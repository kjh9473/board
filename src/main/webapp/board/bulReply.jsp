	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				<form action="/bulReply" method="post" id="frm">
					...
					<span>첨부파일</span><br/>
					<input type = "hidden" id = "bul_brd" name = "bul_brd" value ="${bulVo.bul_brd}">
					<input type = "hidden" id = "bul_pid" name = "bul_pid" value ="${bulVo.bul_id}">
